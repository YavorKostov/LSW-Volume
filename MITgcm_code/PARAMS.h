...
C     YGmskFile       :: File containing YGmsk
C     XGmskFile       :: File containing XGmsk
...
C     the_run_name    :: string identifying the name of the model "run"
     ...
     &                bathyFile, topoFile, XGmskFile, YGmskFile, 
     &                addWwallFile, addSwallFile,
     ...
     &                the_run_name
      ...
      CHARACTER*(MAX_LEN_FNAM) XGmskFile, YGmskFile
...
C     kdepth           deepest vertical level for the cost function
...
C     pressRefSig   :: Pressure reference for potential density
C     PVlowBnd      :: Lower bound on Ertel PV
C     PVupBnd       :: Upper bound on Ertel PV
C     SigmaUpBnd    :: Upper bound on potential density
C     SigmaLowBnd   :: Lower bound on potential density
     ...
     & pressRefSig, SigmaLowBnd, SigmaUpBnd,
     & PVlowBnd, PVupBnd
      ...
      _RL pressRefSig, SigmaLowBnd, SigmaUpBnd
      _RL PVlowBnd, PVupBnd
